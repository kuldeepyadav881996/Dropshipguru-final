...
catalogues-data.js  google-sheet-submit.js  payment-client.js  legal-page.js  legal-page.css
...
**Critical payment/Sheets files (must overwrite live):** `payment-client.js`, `google-sheet-submit.js`, `consultation.html`, `index.html`  
**Render env:** `GOOGLE_SCRIPT_URL` must be the public `https://script.google.com/macros/s/.../exec` URL (not workspace `/a/macros/`).
...
- [ ] Consultation form endpoint reachable: `google-sheet-submit.js` posts to the public Google Apps Script Web App (`script.google.com/macros/s/...`)
