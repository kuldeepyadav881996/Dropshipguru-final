...
- **Organization** (`https://dropshipguru.in/#organization`) — homepage. Includes `name`, `legalName: "DropShipGuru ( Chandrahas )"`, `logo`, `sameAs` (Instagram, YouTube, Facebook), `areaServed: IN`.
