  ...
  <footer id="siteFooter">
    ...
    <div class="footer-inner">
      <div class="footer-brand">
        ...
        <p class="footer-desc">DropshipGuru is owned and operated by <b>DropShipGuru ( Chandrahas )</b>.</p>
      ...
      <div class="footer-col">
        ...
        <ul class="footer-contact-list">
          <li class="footer-contact-block">
            ...
            <span class="footer-contact-text">DropShipGuru ( Chandrahas )</span>
          </li>
          <li class="footer-contact-block">
    ...
    <div class="footer-meta">
      ...
      <div class="footer-bottom">
        <p class="footer-disclaimer" style="width:min(1280px,calc(100% - 48px));margin:0 auto;padding:14px 24px 0;font-size:11.5px;line-height:1.65;color:#6a6560;text-align:center;">Results may vary from person to person. DropShipGuru ( Chandrahas ) does not guarantee any fixed income, profits, or business success. Business results depend on individual effort, investment, market conditions, and other external factors.</p>
        <div class="footer-bottom-inner">
          <p class="footer-copy">© 2026 DropShipGuru ( Chandrahas ).<br>All Rights Reserved.</p>
