...
<meta property="og:site_name" content="DropshipGuru">
  ...
  <footer id="siteFooter">
    ...
    <div class="footer-inner">
      <div class="footer-brand">
        ...
        <p class="footer-desc">DropshipGuru is owned and operated by <b>DropshipGuru</b>.</p>
      ...
      <div class="footer-col">
        ...
        <ul class="footer-contact-list">
          <li class="footer-contact-block">
            ...
            <span class="footer-contact-text">DropshipGuru</span>
          </li>
          <li class="footer-contact-block">
